...
> = {
  en: {
    ...
    "admin.approveCleanerFailed": "Unable to approve cleaner.",
    ...
    "admin.rejectCleaner": "Reject Cleaner",
    "admin.requestResubmission": "Request Resubmission",
    "admin.reviewReason": "Rejection or Resubmission Reason",
    "admin.reviewReasonPlaceholder": "Example: Aadhaar image is blurry.",
    "admin.updateVerificationFailed": "Unable to update verification.",
    "admin.verificationStatus": "Verification Status",
    "auth.aadhaarImageRequired": "Aadhaar image is required.",
    "auth.agreeTo": "I agree to the",
    "auth.drivingLicenseImageRequired": "Driving license image is required.",
    "auth.drivingLicenseRequired": "Driving license is required.",
    "auth.profilePhotoRequired": "Profile photo is required.",
    "auth.termsAndConditions": "Terms and Conditions",
    "auth.termsRequired": "Please accept the terms and conditions to continue.",
    "booking.cleanerDetails": "Cleaner Details",
    "booking.cleanerSummary": "Rating {rating} | Jobs {jobs}",
    "booking.verificationPending": "Verification pending",
    "booking.verifiedCleaner": "Verified cleaner",
    "common.saving": "Saving...",
    "profile.aadhaar12Digit": "12-digit Aadhaar number",
    "profile.aadhaarDocument": "Aadhaar Document",
    "profile.aadhaarFrontImage": "Aadhaar front image",
    "profile.aadhaarImage": "Aadhaar Image",
    "profile.aadhaarNumber": "Aadhaar Number",
    "profile.aadhaarSubmitted": "Aadhaar document submitted for review.",
    "profile.added": "Added",
    "profile.chooseAadhaarImage": "Choose Aadhaar Image",
    "profile.chooseImage": "Choose Image",
    "profile.chooseLicenseImage": "Choose License Image",
    "profile.drivingLicenseImage": "Driving License Image",
    "profile.drivingLicenseSubmitted": "Driving license submitted for review.",
    "profile.identityVerification": "Identity Verification",
    "profile.keepCurrentNumber": "Leave blank to keep the current number",
    "profile.missing": "Missing",
    "profile.noImageSelected": "No image selected",
    "profile.optional": "Optional",
    "profile.optionalOrMissing": "Optional or missing",
    "profile.profilePhoto": "Profile Photo",
    "profile.profilePhotoUploaded": "Profile photo uploaded.",
    "profile.saveAadhaar": "Save Aadhaar",
    ...
    "profile.uploadingDocument": "Uploading document...",
  },
  te: {
    "admin.aadhaarCard": "ఆధార్ కార్డ్",
    "admin.approveCleaner": "క్లీనర్‌ను ఆమోదించండి",
    "admin.approveCleanerFailed": "క్లీనర్‌ను ఆమోదించలేకపోయాం.",
    ...
    "admin.reviewReason": "తిరస్కరణ లేదా మళ్లీ సమర్పణ కారణం",
    "admin.reviewReasonPlaceholder": "ఉదా: ఆధార్ చిత్రం స్పష్టంగా లేదు.",
    "admin.updateVerificationFailed": "వెరిఫికేషన్ అప్‌డేట్ చేయలేకపోయాం.",
    "admin.verificationStatus": "వెరిఫికేషన్ స్థితి",
    "auth.aadhaarImageRequired": "ఆధార్ చిత్రం అవసరం.",
    "auth.agreeTo": "నేను అంగీకరిస్తున్నాను",
    "auth.drivingLicenseImageRequired": "డ్రైవింగ్ లైసెన్స్ చిత్రం అవసరం.",
    "auth.drivingLicenseRequired": "డ్రైవింగ్ లైసెన్స్ అవసరం.",
    "auth.profilePhotoRequired": "ప్రొఫైల్ ఫోటో అవసరం.",
    "auth.termsAndConditions": "నిబంధనలు మరియు షరతులు",
    "auth.termsRequired": "కొనసాగడానికి నిబంధనలు మరియు షరతులను అంగీకరించండి.",
    "booking.cleanerDetails": "క్లీనర్ వివరాలు",
    "booking.cleanerSummary": "రేటింగ్ {rating} | పనులు {jobs}",
    "booking.verificationPending": "వెరిఫికేషన్ పెండింగ్‌లో ఉంది",
    "booking.verifiedCleaner": "వెరిఫైడ్ క్లీనర్",
    "common.saving": "సేవ్ అవుతోంది...",
    "profile.aadhaar12Digit": "12 అంకెల ఆధార్ నంబర్",
    "profile.aadhaarDocument": "ఆధార్ డాక్యుమెంట్",
    "profile.aadhaarFrontImage": "ఆధార్ ముందు చిత్రం",
    "profile.aadhaarImage": "ఆధార్ చిత్రం",
    "profile.aadhaarNumber": "ఆధార్ నంబర్",
    "profile.aadhaarSubmitted": "ఆధార్ డాక్యుమెంట్ సమీక్షకు పంపబడింది.",
    "profile.added": "జోడించబడింది",
    "profile.chooseAadhaarImage": "ఆధార్ చిత్రం ఎంచుకోండి",
    "profile.chooseImage": "చిత్రం ఎంచుకోండి",
    "profile.chooseLicenseImage": "లైసెన్స్ చిత్రం ఎంచుకోండి",
    ...
    "profile.optionalOrMissing": "ఐచ్ఛికం లేదా లేదు",
    "profile.profilePhoto": "ప్రొఫైల్ ఫోటో",
    "profile.profilePhotoUploaded": "ప్రొఫైల్ ఫోటో అప్‌లోడ్ అయింది.",
    "profile.saveAadhaar": "ఆధార్ సేవ్ చేయండి",
    ...
    "profile.uploadingDocument": "డాక్యుమెంట్ అప్‌లోడ్ అవుతోంది...",
  },
  hi: {
    "admin.aadhaarCard": "आधार कार्ड",
    "admin.approveCleaner": "क्लीनर मंजूर करें",
    "admin.approveCleanerFailed": "क्लीनर को मंजूर नहीं कर पाए.",
    ...
    "admin.reasonRequired": "कारण जरूरी है.",
    "admin.rejectCleaner": "क्लीनर अस्वीकार करें",
    "admin.requestResubmission": "फिर से जमा करने को कहें",
    "admin.reviewReason": "अस्वीकार या फिर से जमा करने का कारण",
    "admin.reviewReasonPlaceholder": "उदाहरण: आधार इमेज धुंधली है.",
    "admin.updateVerificationFailed": "वेरिफिकेशन अपडेट नहीं कर पाए.",
    "admin.verificationStatus": "वेरिफिकेशन स्थिति",
    "auth.aadhaarImageRequired": "आधार इमेज जरूरी है.",
    "auth.agreeTo": "मैं सहमत हूं",
    "auth.drivingLicenseImageRequired": "ड्राइविंग लाइसेंस इमेज जरूरी है.",
    "auth.drivingLicenseRequired": "ड्राइविंग लाइसेंस जरूरी है.",
    "auth.profilePhotoRequired": "प्रोफाइल फोटो जरूरी है.",
    "auth.termsAndConditions": "नियम और शर्तें",
    "auth.termsRequired": "जारी रखने के लिए नियम और शर्तें स्वीकार करें.",
    "booking.cleanerDetails": "क्लीनर विवरण",
    "booking.cleanerSummary": "रेटिंग {rating} | काम {jobs}",
    "booking.verificationPending": "वेरिफिकेशन लंबित है",
    "booking.verifiedCleaner": "वेरिफाइड क्लीनर",
    "common.saving": "सेव हो रहा है...",
    "profile.aadhaar12Digit": "12 अंकों का आधार नंबर",
    "profile.aadhaarDocument": "आधार दस्तावेज",
    "profile.aadhaarFrontImage": "आधार फ्रंट इमेज",
    "profile.aadhaarImage": "आधार इमेज",
    "profile.aadhaarNumber": "आधार नंबर",
    "profile.aadhaarSubmitted": "आधार दस्तावेज समीक्षा के लिए भेजा गया.",
    "profile.added": "जोड़ा गया",
    "profile.chooseAadhaarImage": "आधार इमेज चुनें",
    ...
    "profile.noImageSelected": "कोई इमेज नहीं चुनी गई",
    "profile.optional": "वैकल्पिक",
    "profile.optionalOrMissing": "वैकल्पिक या नहीं है",
    "profile.profilePhoto": "प्रोफाइल फोटो",
    "profile.profilePhotoUploaded": "प्रोफाइल फोटो अपलोड हो गई.",
    "profile.saveAadhaar": "आधार सेव करें",
    "profile.saveLicense": "लाइसेंस सेव करें",
    "profile.saveProfilePhoto": "प्रोफाइल फोटो सेव करें",
    "profile.selectAadhaarImage": "कृपया आधार इमेज चुनें.",
    "profile.selectDrivingLicenseImage": "कृपया ड्राइविंग लाइसेंस इमेज चुनें.",
    "profile.selectProfilePhoto": "कृपया प्रोफाइल फोटो चुनें.",
    "profile.uploadFailed": "अपलोड विफल हुआ.",
    "profile.uploaded": "अपलोड हो गया",
    "profile.uploadingDocument": "दस्तावेज अपलोड हो रहा है...",
  },
};
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo<LanguageContextValue>(
    () => ({
      ...
      t: (key, params) => {
        const template =
          latestChangeDictionaries[language][key] ??
          extraDictionaries[language][key] ??
          dictionaries[language][key] ??
          latestChangeDictionaries.en[key] ??
